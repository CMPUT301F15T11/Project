 ...
 */
public class testUS041201flow2 extends ActivityInstrumentationTestCase2 {
    Activity activity;
    public testUS041201flow2() {
        super(TradeCenterActivity.class);
    }

    public void testBrowse_trades_completed() throws Exception {
        ...
        activity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Button completed = (Button) activity.findViewById(R.id.btn_browse_trades_completed);
