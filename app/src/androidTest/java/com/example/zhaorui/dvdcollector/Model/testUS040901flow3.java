 ...
 */
public class testUS040901flow3 extends ActivityInstrumentationTestCase2 {
    Activity activity;
    public testUS040901flow3() {
        super(TradeCenterActivity.class);
    }

    public void testBrowse_current_incoming() throws Exception {
