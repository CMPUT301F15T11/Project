 ...
 */
public class testUS040901flow4 extends ActivityInstrumentationTestCase2 {
    Activity activity;

    public testUS040901flow4() {
        super(TradeCenterActivity.class);
    }

    public void testBrowse_current_outgoing() throws Exception {
        ...
        activity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Button current_outgoing = (Button) activity.findViewById(R.id.btn_browse_trades_current_outgoing);
                current_outgoing.performClick();
